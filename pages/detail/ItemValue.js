export const ItemValue = ({ item }) => {
  ...
  return (
    <div className="mr-2 h-full  w-full bg-white p-12  sm:rounded-lg">
      <h1 className="mb-12 text-4xl font-extrabold tracking-tight text-gray-800 dark:text-white sm:text-5xl">
        {item.title}
      </h1>

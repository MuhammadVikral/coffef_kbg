...
const FooterCompanyProfile = () => (
  <div className="grid grid-cols-1 justify-center md:inline-block">
    <img
      src="/images/logo.png"
      alt="logo"
      className=" mb-4 flex w-full  justify-center object-cover md:w-48"
    />
...
const FooterSosmedLayout = () => (
  <div className="mb-9 flex justify-center md:justify-start">
    <a
      href="https://www.instagram.com/vikralikal/"
      target="_blank"
    ...
    <a
      href="https://api.whatsapp.com/send?phone=6281214004800&text=Hello "
      target="_blank"
...
const FooterContentLayout = () => (
  <div className="grid grid-cols-1 gap-8 md:grid-cols-5 ">
    <div className="col-span-2 grid grid-cols-1 gap-8 md:grid-cols-1">
